		...
		<table>
			<tr>
				...
				<td><select name="rendicionId">
					<?php
						$mesa=new Mesa();
						$resultadoRendiciones=$mesa->buscar();
						while ($fila = mysqli_fetch_object($resultadoRendiciones)) {
								echo "<option value=".$fila->rendicionId.">".$fila->fecha." ".$fila->materia."</option>";
							}
